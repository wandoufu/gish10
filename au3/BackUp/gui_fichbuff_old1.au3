...
Func Example()
    ...
    While 1
        Switch GUIGetMsg()
            case $__gid_fishbuff_toggle 
                _fishbuff_ToggleCtrlEnable()
            Case $__gid_fishbuff[0][0],$__gid_fishbuff[0][1],$__gid_fishbuff[0][2], _
                 $__gid_fishbuff[1][0],$__gid_fishbuff[1][1],$__gid_fishbuff[1][2], _
                 $__gid_fishbuff[2][0],$__gid_fishbuff[2][1],$__gid_fishbuff[2][2], _
                 $__gid_fishbuff[3][0],$__gid_fishbuff[3][1],$__gid_fishbuff[3][2], _
                 $__gid_fishbuff[4][0],$__gid_fishbuff[4][1],$__gid_fishbuff[4][2]
